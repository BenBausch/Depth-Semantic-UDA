...
class _PathsKittiFromMotion(dataset_base.PathsHandlerDepthFromMotion):
    ...
    def get_sparse_depth_image_paths(self, mode, drive_seqs='*', cam_ids='[2,3]', frame_ids='*', format=".png", split=None):
    ...
    def get_rgb_image_path(path_base, mode, drive_seqs, cam_ids, frame_ids, format):
        return '{}/{}/{}/rgb/image_0{}/data/{}{}'.format(path_base, mode, drive_seqs, cam_ids, frame_ids, format)

    @staticmethod
    def get_gt_depth_image_path(path_base, mode, drive_seqs, cam_ids, frame_ids, format):
        return '{}/{}/{}/groundtruth/proj_depth/image_0{}/{}{}'.format(path_base, mode, drive_seqs, cam_ids, frame_ids, format)

    @staticmethod
    def get_sparse_depth_image_path(path_base, mode, drive_seqs, cam_ids, frame_ids, format):
        return '{}/{}/{}/velodyne_raw/proj_depth/image_0{}/{}{}'.format(path_base, mode, drive_seqs, cam_ids, frame_ids, format)
    ...
    # that the depth images are also consistent if downloaded from the official Kitti webpage
