...
class PathsHandlerDepth(PathsHandlerRGB):
    """
...
class DatasetSemantic(DatasetRGB):
    def __init__(self, pathsObj, cfg):
...
class DatasetDepth(DatasetRGB):
    ...
    @abc.abstractmethod
    def tf_depth_train(self):
        pass

    @abc.abstractmethod
    def tf_depth_val(self):
        pass