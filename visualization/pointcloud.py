...
data = np.load(r'C:\Users\benba\Documents\University\Masterarbeit\Depth-Semantic-UDA\visualization\data\ddad_eval.npz')
...
draw = Draw(wh=(2000, 900), title='CamViz Pointcloud Demo')
...
hgt_clr = jet(-points[:, 1])    # Height colors
