...
from train.semantic_and_depth.supervised_depth_supervised_semantic_single_ds import SemanticDepthTrainer
...
if __name__ == "__main__":
    ...
    if cfg.device.multiple_gpus:
        ...
        mp.spawn(run_trainer, nprocs=torch.cuda.device_count(),
                 args=(cfg, torch.cuda.device_count(), SemanticDepthTrainer,))
    else:
