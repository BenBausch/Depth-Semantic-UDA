...
class PackNet01(nn.Module):
    ...
    kwargs : dict
        Extra parameters
    """
    # ToDo: There are two different versions. I didn't specify yet which one to use
    def __init__(self, version="1A", dropout=None, **kwargs):
        super().__init__()
    ...
    def forward(self, x):
        ...
        # ToDo: KP: We do not use the multiple scale output from the network yet in the reconstruction error, maybe
        #  later...
        # if self.training:
